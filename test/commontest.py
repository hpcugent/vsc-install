...
class CommontestTest(TestCase):
    ...
    def test_check_autogenerated_ci_config_file(self):
        ...
        self.assertErrorRegex(
            FileNotFoundError, ".*", check_autogenerated_ci_config_file, mocked_self, test_fn, test_contents
        )
        ...
        Path(test_fn + ".NOT_AUTOGENERATED_YET").write_text(
            "https://github.com/hpcugent/vsc-install/issues/1234", encoding="utf8"
        )
        check_ignore(True)
